...
/*   Updated: 2025/10/13 19:15:58 by mvigara-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void p_test() {
    ...
    TEST(4, " %p ", (void *)16);
    TEST(5, " %p ", (void *)17);
    TEST(6, " %p %p ", (void *)LONG_MIN, (void *)LONG_MAX);
    TEST(7, " %p %p ", (void *)INT_MIN, (void *)INT_MAX);
    TEST(8, " %p %p ", (void *)ULONG_MAX, (void *)-ULONG_MAX);
    TEST(9, " %p %p ", (void *)0, (void *)0);
    TEST(10, "%p", (void *)1);
    TEST(11, "%p", (void *)-1);
    TEST(12, "%p", (void *)105);
    TEST(13, "%p", (void *)0);
...
void simple_test()
{
    ...
    TEST(3, "\n\v\t\r\f\b\a");
    TEST(4, " %s %c %d %i %u %x %X %p %%", "hola", 'c', 42, 42, 42, 42, 42, (void*)42);
...
void run_test(char *specifier) {
    if (strcmp(specifier, "s") == 0) {
        ...
        zero_test();
    } else if (strcmp(specifier, "bonus") == 0) {
        bonus_test();
...
int main(int argc, char *argv[]) {
    if (argc < 2) {
        ...
        printf("Especificadores disponibles:\n");
        printf("  s  - Pruebas para strings (%%s)\n");
        printf("  c  - Pruebas para caracteres (%%c)\n");
        printf("  u  - Pruebas para enteros sin signo (%%u)\n");
        printf("  x  - Pruebas para hexadecimal en minúsculas (%%x)\n");
        printf("  X  - Pruebas para hexadecimal en mayúsculas (%%X)\n");
        printf("  %%  - Pruebas para el símbolo de porcentaje (%%%%)\n");
        printf("  d  - Pruebas para enteros con signo (%%d)\n");
        printf("  i  - Pruebas para enteros con signo (%%i)\n");
        printf("  p  - Pruebas para punteros (%%p)\n");
        printf("  +  - Pruebas para el flag de signo (+)\n");
        printf("  0  - Pruebas para el flag de cero (0)\n");
        printf("  simple - Pruebas simples con múltiples conversores\n");
        printf("  bonus  - Pruebas para los bonus (flags #, espacio, +, 0, -)\n");
        printf("  all    - Ejecuta todas las pruebas\n");
        return 1;
    }
